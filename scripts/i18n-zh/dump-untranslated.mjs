// Dump untranslated zh-CN entries into chunk JSON files for translation.
// Run from the repo root: node scripts/i18n-zh/dump-untranslated.mjs [chunkSize]
...
const OUT_DIR = "scripts/i18n-zh/zh-chunks";
