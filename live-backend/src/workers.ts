...
const DEFAULT_WORKER_LANES: WorkerLane[] = [
  ...
  },
  {
    ...
    name: "chart-analysis",
    jobTypes: [CHART_ANALYSIS_JOB, CHART_ANALYSIS_BACKFILL_JOB, VIBRO_RECOMPUTE_JOB, DAN_FLOOR_PIN_RECOMPUTE_JOB, LN_SUBTYPE_RECOMPUTE_JOB, LN_SOURCE_RECOMPUTE_JOB, DT_RATE_ANALYSIS_JOB, NOTE_BPM_RECOMPUTE_JOB],
    claimLimit: 1,
