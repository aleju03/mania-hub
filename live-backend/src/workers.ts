...
import { CHART_ANALYSIS_BACKFILL_JOB, CHART_ANALYSIS_JOB, DAN_FLOOR_PIN_RECOMPUTE_JOB, VIBRO_RECOMPUTE_JOB, computeBeatmapChartAnalysis, runChartAnalysisBackfillJob, runDanFloorPinRecomputeJob, runVibroRecomputeJob } from "./features/chart-analysis.js";
...
const DEFAULT_WORKER_LANES: WorkerLane[] = [
  ...
  },
  {
    ...
    name: "chart-analysis",
    jobTypes: [CHART_ANALYSIS_JOB, CHART_ANALYSIS_BACKFILL_JOB, VIBRO_RECOMPUTE_JOB, DAN_FLOOR_PIN_RECOMPUTE_JOB],
    claimLimit: 1,
