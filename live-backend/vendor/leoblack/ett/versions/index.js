...
const ETTERNA_VERSION_REGISTRY = Object.freeze({
    "0.68.0-Unofficial": {
        ...
        wasmFileName: "minaclac-68.0-unofficial.wasm",
        reason: null,
        supportedKeycounts: COMMON_SUPPORTED_KEYCOUNTS,
    },
    "0.70.0": {
        loader: createMinaCalc700,
        wasmFileName: "minaclac-70.0.wasm",
        reason: null,
        supportedKeycounts: COMMON_SUPPORTED_KEYCOUNTS,
    },
    "0.72.0": {
        loader: createMinaCalc720,
        wasmFileName: "minaclac-72.0.wasm",
        reason: null,
        supportedKeycounts: COMMON_SUPPORTED_KEYCOUNTS,
    },
    "0.72.3": {
        loader: createMinaCalc723,
        wasmFileName: "minaclac-72.3.wasm",
        reason: null,
        supportedKeycounts: COMMON_SUPPORTED_KEYCOUNTS,
    },
    "0.74.0": {
...
export function resolveEtternaVersionLoader(value) {
    ...
    if (requestedEntry && typeof requestedEntry.loader === "function") {
        return {
            ...
            wasmFileName: requestedEntry.wasmFileName,
            fallbackReason: null,
        };
    }
    ...
    return {
        ...
        wasmFileName: fallbackEntry.wasmFileName,
...
export function resolveEtternaVersionLoaderForKeycount(value, keycount) {
    ...
    if (shouldPreferNon4kStableVersion
        ...
        return {
            ...
            wasmFileName: preferredEntry.wasmFileName,
