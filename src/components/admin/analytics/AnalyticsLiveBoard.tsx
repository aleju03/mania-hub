        ...
        <div className="px-2.5 py-2">
          ...
          {href ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group mt-1 flex items-start gap-1 text-[12px] font-medium leading-snug text-white hover:text-osu-pink-light"
            ...
            <div className="mt-1 line-clamp-2 text-[12px] font-medium leading-snug text-white">{activity.subject}</div>
          )}
          {activity.detail ? (
            <div className="mt-0.5 truncate text-[10px] text-osu-f1">{activity.detail}</div>
          ) : null}
        </div>
        ...
        {trail.length > 0 ? (
          <div className="border-t border-osu-b3/20 px-2.5 py-1.5">
            {trail.map((row, index) => {
              ...
              return (
                <div key={row.eventId ?? `${row.ts}-${index}`} className="flex items-center gap-1.5 py-[1px] text-[10px]">
            ...
            {hiddenSteps > 0 || session.referrer ? (
              <div className="mt-0.5 flex items-center gap-2 text-[9px] text-osu-f1/70">
