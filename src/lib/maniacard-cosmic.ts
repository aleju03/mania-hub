...
export const COSMIC_PALETTES: Record<CardMotifPalette, CosmicTierPalette> = {
  prismatic: {
    base: [[0, "#060610"], [0.4, "#10101e"], [1, "#020207"]],
    foilA: ["rgba(167,139,250,0.38)", "rgba(103,232,249,0.14)"],
    foilB: ["rgba(103,232,249,0.3)", "rgba(167,139,250,0.12)"],
    aurora: ["rgba(167,139,250,0)", "rgba(167,139,250,0.22)", "rgba(103,232,249,0.16)", "rgba(167,139,250,0.12)", "rgba(103,232,249,0)"],
    stars: ["255,255,255", "167,139,250", "103,232,249"], starTint: [0.85, 0.8, 1], rainbow: 1,
    rim: [[0, "rgba(255,255,255,0.8)"], [0.25, "rgba(167,139,250,0.95)"], [0.5, "rgba(103,232,249,0.8)"], [0.8, "rgba(167,139,250,0.9)"], [1, "rgba(255,255,255,0.7)"]],
    rimGlow: "rgba(167,139,250,0.6)", glint: "rgba(255,255,255,0.95)",
  },
  aurora: {
    base: [[0, "#060610"], [0.4, "#10101e"], [1, "#020207"]],
    foilA: ["rgba(45,212,191,0.38)", "rgba(129,140,248,0.14)"],
    foilB: ["rgba(129,140,248,0.3)", "rgba(45,212,191,0.12)"],
    aurora: ["rgba(45,212,191,0)", "rgba(45,212,191,0.22)", "rgba(129,140,248,0.16)", "rgba(45,212,191,0.12)", "rgba(129,140,248,0)"],
    stars: ["255,255,255", "45,212,191", "129,140,248"], starTint: [0.65, 1, 0.93], rainbow: 0.4,
    rim: [[0, "rgba(255,255,255,0.8)"], [0.25, "rgba(45,212,191,0.95)"], [0.5, "rgba(129,140,248,0.8)"], [0.8, "rgba(45,212,191,0.9)"], [1, "rgba(255,255,255,0.7)"]],
    rimGlow: "rgba(45,212,191,0.6)", glint: "rgba(255,255,255,0.95)",
  },
  ember: {
    base: [[0, "#060610"], [0.4, "#10101e"], [1, "#020207"]],
    foilA: ["rgba(251,146,60,0.38)", "rgba(251,113,133,0.14)"],
    foilB: ["rgba(251,113,133,0.3)", "rgba(251,146,60,0.12)"],
    aurora: ["rgba(251,146,60,0)", "rgba(251,146,60,0.22)", "rgba(251,113,133,0.16)", "rgba(251,146,60,0.12)", "rgba(251,113,133,0)"],
    stars: ["255,255,255", "251,146,60", "251,113,133"], starTint: [1, 0.75, 0.45], rainbow: 0.12,
