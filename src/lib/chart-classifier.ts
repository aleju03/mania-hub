...
// (src/lib/leoblack/estimator/intervals/4k-rc-reform.js): below 3.0 Sunny is
...
// not apply. Exported so the live backend's one-shot floor-pin recompute sweep
// (its copy) and tests share the classifier's exact predicate.
