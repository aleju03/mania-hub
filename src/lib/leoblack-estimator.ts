...
} from "./leoblack/estimator/mixedEstimator.js";
import { runSunnyEstimatorFromText } from "./leoblack/estimator/sunnyEstimator.js";
import {
...
export interface LeoBlackDanInput extends DanEstimateInput {
  ...
  // chart is LN-dominant (lnRatio >= 0.5).
...
export function estimateLeoBlackDan(map: ManiaBeatmap, osuText: string, input: LeoBlackDanInput = {}): DanEstimate {
  ...
  const useLn = lnText != null && (prefer === "ln" || (prefer === "auto" && lnRatio >= 0.5));
