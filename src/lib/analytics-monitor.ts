...
const ANALYTICS_EVENT_LABELS: Record<string, string> = {
  ...
  dan_estimates_note: "Dan explainer ScoreV2 note opened",
  dan_estimates_read: "Dan explainer read to the end",
  dan_estimates_saragi: "Dan explainer saragi tooltip found",
  ...
  packs_collections_card: "Card opened",
  packs_collections_directory: "Collector list browsed",
  packs_collections_shelf: "Shelf browsed",
  packs_collections_stats: "Pack stats read",
  packs_collections_wall: "Showcase wall paged",
  packs_showcase_edit: "Showcase picker opened",
  packs_showcase_saved: "Showcase saved",
  page_shared: "Link preview fetched",
  ...
  replay_view: "Replay opened",
  page_load_result: "Document load measured",
  replay_load_result: "Replay data load measured",
  client_error: "Browser exception",
  client_unhandled_rejection: "Unhandled browser rejection",
  replay_watch_crash: "Replay viewer crash",
  route_error: "Page error",
  skill_plays_view: "Skills tab plays list opened",
  snipes_board_all: "Snipe board shown in full",
  snipes_link: "Snipe link followed",
  snipes_row_open: "Snipe opened",
  snipes_rules_open: "Snipe rules opened",
