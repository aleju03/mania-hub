...
const mocks = vi.hoisted(() => ({
  ...
  list: vi.fn(), read: vi.fn(), describe: vi.fn(), owners: vi.fn(), assets: vi.fn(), waitUntil: vi.fn(),
}));
...
vi.mock("./uploaded-replay-describe", () => ({ DESCRIPTION_VERSION: 3, readUploadedReplayDescription: mocks.read, describeUploadedReplayById: mocks.describe }));
