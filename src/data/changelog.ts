...
export const UPDATES: ChangelogUpdate[] = [
  { date: "2026-08-30", text: "Dan estimates now leave up to three passes out of a skillset's average when they credit more than five levels below the average of your five best in it. A dan 4 pass in a skillset whose best five are beta is left out. They still show in the dan window, marked not counted", to: "/dan-estimates" },
