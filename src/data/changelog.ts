...
export const UPDATES: ChangelogUpdate[] = [
  { date: "2026-08-27", text: "Clearing a real dan course now sets your dan for that keymode, even when the average of your skills sits lower. Reform, the 4K LN courses, JinJin's 7K ones and the 6K ones all count, and about 360 players went up from it. Click your dan to see which course did it", to: "/dan-estimates" },
