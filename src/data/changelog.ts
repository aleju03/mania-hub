...
export const UPDATES: ChangelogUpdate[] = [
  ...
  { date: "2026-09-16", text: "Only your two best rate plays on the same chart count toward dan now, and both count fully. Before, every rate of a chart contributed a shrinking share. Verified rate reuploads share the same limit", to: "/dan-estimates" },
